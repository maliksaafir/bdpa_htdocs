    ...
    <div class="form-container">
      ...
      <form action="review.php" method="POST">
        <div class="group">
          ...
          <input name="cheese" type="radio" value="Cheese"><span>Regular Cheese</span>
        ...
        <div class="group">
          ...
          <input name="fruit-veggies" type="checkbox" value="Bell Peppers"><span>Bell Peppers</span>
          <input name="fruit-veggies" type="checkbox" value="Onions"><span>Onions</span>
          <input name="fruit-veggies" type="checkbox" value="Olives"><span>Olives</span>
          <input name="fruit-veggies" type="checkbox" value="Pineapple"><span>Pineapple</span>
        </div>
